...
a persistence unit "EXAMENCanarJuanPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EXAMENCanarJuan\pom.xml":
...
artifact ("EXAMENCanarJuan.war") is already built. You can build
